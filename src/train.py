...
from StableVITON.cldm.logger import ImageLogger
from StableVITON.cldm.model import create_model, load_state_dict
from StableVITON.utils import save_args

def build_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--config_name", type=str, default=None)
    parser.add_argument("--data_root_dir", type=str, default="/home/data2/xiangyu/Code/StableVITON/dataset")
    parser.add_argument("--category", type=str, default=None, choices=["upper", "lower_body", "dresses"])
    parser.add_argument("--vae_load_path", type=str, default="/home/data2/xiangyu/Code/StableVITON/ckpts/VITONHD_VAE_finetuning.ckpt")
...
def main_worker(args):
    ...
    train_dataset = getattr(import_module("StableVITON.dataset"), config.dataset_name)(
    ...
    valid_paired_dataset = getattr(import_module("StableVITON.dataset"), config.dataset_name)(
        data_root_dir=args.data_root_dir, 
        img_H=args.img_H, 
        img_W=args.img_W, 
        is_test=True, 
    ...
    valid_unpaired_dataset = getattr(import_module("StableVITON.dataset"), config.dataset_name)(
        data_root_dir=args.data_root_dir, 
        img_H=args.img_H, 
        img_W=args.img_W, 
        is_test=True, 
...
if __name__ == "__main__":
    # print(cv2.imread('/home/data2/xiangyu/Code/StableVITON/dataset/train/agnostic-mask/14301_00_mask.png'))
    args = build_args()
    print(args)
