...
class VITONHDDataset(Dataset):
    def __init__(
        ...
        self.sketch = "/home/data2/xiangyu/Code/StableVITON/dataset/cloth_sketch/results"
        ...
        self.text_dataset = json.load(open('/home/data2/xiangyu/Code/StableVITON/dataset/vitonhd/captions.json'))
    ...
    def __getitem__(self, idx):
        ...
        captions = self.text_dataset[cloth_fn[:5]]
        ...
        if self.transform_size is None and self.transform_color is None:
            ...
            cloth_sketch = imread_for_albu(opj(self.sketch, self.data_type, self.c_names[self.pair_key][idx].replace(".jpg", ".png")))
            ...
            if self.transform_size is not None:
                ...
                cloth_sketch=transformed["cloth_sketch"]
            ...
            if self.transform_crop_cloth is not None:
                ...
                cloth_sketch=transformed_cloth["cloth_sketch"]
            ...
            cloth_sketch= norm_for_albu(cloth_sketch)
            # cloth_sketch = cloth_sketch.expand(32,3,224,224)
        ...
        return dict(
            ...
            img_fn=img_fn,
            cloth_fn=cloth_fn,
            cloth_sketch_mask=cloth_sketch
        )